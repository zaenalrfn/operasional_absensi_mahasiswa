...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Edit',
        href: `/lectures/${props.lecture.id}/edit`,
    },
];

const form = useForm({
    name: props.lecture.name,
    email: props.lecture.email,
});

const submit = () => {
    form.put(route('lectures.update', props.lecture.id));
};
</script>

<template>
    <Head title="Edit Lecture" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-6">
            <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md dark:bg-gray-800">
                <h2 class="text-2xl font-bold mb-6 text-gray-800 dark:text-white">Edit Dosen</h2>
